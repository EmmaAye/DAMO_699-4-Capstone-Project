...
# DBTITLE 1,Install lifelines package
...
PATH_CPH_NYC = "/Workspace/Repos/jihirosan@gmail.com/damo_699-4-capstone-project/output/models/cph_NYC.pkl"
PATH_CPH_TORONTO = "/Workspace/Repos/jihirosan@gmail.com/damo_699-4-capstone-project/output/models/cph_Toronto.pkl"
...
if not all_hazard_ratios.empty:
    spark.createDataFrame(all_hazard_ratios).write.mode("overwrite") \
        ...
        .saveAsTable("workspace.capstone_project.dashboard_hazard_ratios")
...
try:
    ...
    combined_forecast.select("City", "prediction", "actual_label", "delay_risk_probability", "response_minutes") \
        ...
        .option("overwriteSchema", "true") \
        .saveAsTable("workspace.capstone_project.dashboard_predictions_all")

    # Save for Risk Distribution
    combined_forecast.select("City", "delay_risk_probability") \
        .write.mode("overwrite") \
        .option("overwriteSchema", "true") \
        .saveAsTable("workspace.capstone_project.dashboard_risk_distribution")
