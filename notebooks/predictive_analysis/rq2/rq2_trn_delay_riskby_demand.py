...
if len(all_results) > 0:
    ...
    results_path = os.path.join(output_dir, "rq2_toronto_model_comparison.csv")
...
if len(roc_points_dfs) > 0:
    ...
    # File path
    csv_path = os.path.join(output_dir, "rq2_toronto_roc_points_all_models.csv")
