...
# =========================================================
naive_df = pd.read_csv(f"{tables_dir}/rq1_nyc_naive_baseline_metrics.csv")
lr_df = pd.read_csv(f"{tables_dir}/rq1_nyc_logistic_regression_metrics.csv")
rf_df = pd.read_csv(f"{tables_dir}/rq1_nyc_random_forest_metrics.csv")
gbt_df = pd.read_csv(f"{tables_dir}/rq1_nyc_gbt_metrics.csv")
...
comparison_df.to_csv(f"{tables_dir}/rq1_nyc_model_comparison.csv", index=False)

print("=====================================================")
print("NYC MODEL COMPARISON TABLE")
print("=====================================================")
...
comparison_pretty_df.to_csv(
    f"{tables_dir}/rq1_nyc_model_comparison_rounded.csv",
    index=False
)
...
# 5. LOAD ROC POINTS
# =========================================================
lr_roc = pd.read_csv(f"{graphs_dir}/rq1_nyc_logistic_regression_roc_points.csv")
rf_roc = pd.read_csv(f"{graphs_dir}/rq1_nyc_random_forest_roc_points.csv")
gbt_roc = pd.read_csv(f"{graphs_dir}/rq1_nyc_gbt_roc_points.csv")
...
plt.title("NYC Model Comparison - ROC Curves")
plt.legend(loc="lower right")
plt.tight_layout()
plt.savefig(f"{graphs_dir}/rq1_nyc_combined_roc_curve.png", dpi=300)
plt.show()
...
plt.title("NYC Model Performance Comparison")
plt.ylabel("Score")
plt.xlabel("Model")
plt.xticks(rotation=20)
plt.tight_layout()
plt.savefig(f"{graphs_dir}/rq1_nyc_model_comparison_bar_chart.png", dpi=300)
plt.show()
