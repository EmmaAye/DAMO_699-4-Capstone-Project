...
metrics_csv_path = f"{output_dir}/tables/rq1_nyc_naive_baseline_metrics.csv"
pred_dist_csv_path = f"{output_dir}/graphs/rq1_nyc_naive_baseline_prediction_distribution.csv"
...
# 2. LOAD DATA
# =========================================================
df = spark.table("workspace.capstone_project.nyc_model_ready").filter(col(label_col).isNotNull())
