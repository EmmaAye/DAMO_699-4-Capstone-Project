...
try:
    ...
    metric_path = f"{output_dir}/tables/rq1_nyc_gbt_metrics.csv"
    ...
    roc_values_path = f"{output_dir}/graphs/rq1_nyc_gbt_roc_points.csv"
    ...
    plt.title("NYC ROC Curve - GBT")
    plt.legend(loc="lower right")
    plt.tight_layout()
    plt.savefig(f"{output_dir}/graphs/rq1_nyc_gbt_roc_curve.png", dpi=300)
    plt.close()
