...
print("Starting RQ4 NYC Random Forest...")
...
try:
    ...
    metric_path = os.path.join(tables_dir, "rq4_nyc_random_forest_metrics.csv")
    ...
    # =====================================================
    rf_stage = fitted_model.stages[-1]
    ...
    artifact_path = os.path.join(models_dir, "rq4_nyc_random_forest_artifact.json")
    ...
    feat_imp_csv_path = os.path.join(tables_dir, "rq4_nyc_random_forest_feature_importance.csv")
    ...
    roc_values_path = os.path.join(graphs_dir, "rq4_nyc_random_forest_roc_points.csv")
    ...
    plt.title("RQ4 NYC ROC Curve - Random Forest")
    plt.legend(loc="lower right")
    plt.tight_layout()

    roc_curve_path = os.path.join(graphs_dir, "rq4_nyc_random_forest_roc_curve.png")
...
print("RQ4 NYC Random Forest complete.")
