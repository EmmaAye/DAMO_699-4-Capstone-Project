# ============================================
# RQ5 Subtask (Baseline): Toronto Tail-Risk Model (GBT Regression)
...
SAVE_MODEL_PATH = "/Volumes/workspace/capstone_project/models/tail_risk_model_toronto"
SAVE_RESULTS_TABLE = "workspace.capstone_project.rq5_tailrisk_baseline_toronto"
...
print("Toronto tail-risk baseline summary:")
display(summary)
...
# Minimal fix: Remove directory if it exists before saving
