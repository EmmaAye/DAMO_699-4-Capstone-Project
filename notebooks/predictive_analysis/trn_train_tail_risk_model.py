...
spark = SparkSession.builder.appName("TailRiskModel_Toronto").getOrCreate()
...
# Save Model
model_tail.write().overwrite().save("/Volumes/workspace/capstone_project/models/tail_risk_model_toronto")